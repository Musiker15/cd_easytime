...
Config.Language = 'DE' --[ 'EN' / 'FR' / 'ES' ] You can add your own locales to the Locales.lua. But make sure to add it here.
...
Config.TimeCycleSpeed = 60 --(in seconds) Changing this value will effects the day/night time cycle, decreasing slows it down, incresing speeds it up. Right now its similar to the default gta5 time cycle.
Config.DynamicWeather_time = 60 --(in minutes) If dynamic weather is enabled, this value is how long until the weather changes.
